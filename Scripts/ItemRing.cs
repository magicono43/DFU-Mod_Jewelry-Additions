...
{
    public class ItemRing : DaggerfallUnityItem
    {
        public const int templateIndex = 4700;
        public const string baseName = "Ring";

        public static int ringType = -1;

        public ItemRing() : base(ItemGroups.Jewellery, templateIndex)
        {
            if (ringType >= 0)
                message = ringType;
            else
        ...
        public override ItemData_v1 GetSaveData()
        {
            ...
            data.className = typeof(ItemRing).ToString();
            return data;
        }
    }
}
